...
public class RippleLayoutOrigin extends FrameLayout {
    //图片横向、纵向的格数
    ...
    public RippleLayoutOrigin(@NonNull Context context) {
        this(context,null);
    }

    public RippleLayoutOrigin(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RippleLayoutOrigin(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
